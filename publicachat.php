...
function cambiarfecha($fecha)
{
 ...
 $consul14="SELECT * FROM chat WHERE  idpara = '".$_SESSION['id']."' OR ide='".$_SESSION['id']."' ORDER BY fecha DESC ";
        ...
        ?>
               <div class="publicaciones " id="">
                    <div class="row" >
                            ...
                            <a class="" href=""> <img class=""src="data:image/jpg; base64 ,<?php echo base64_encode($row18['avatar'])?>" alt=""> </a>
                            </div>
                            <div class="col post">
                                <a class="nombre"href=""><?php  echo $row18['Nombre']?></a>
                                <p ><?php  echo cambiarfecha($row14['fecha'])?></p>
                                <div class="mensachat">
                                     <p  style="color:green"class="textochat"><?php  echo $row14['mensaje']?></p>
